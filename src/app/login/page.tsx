  ...
  return (
    <div className="relative flex size-full min-h-screen flex-col group/design-root overflow-x-hidden bg-slate-50" style={{ fontFamily: 'Inter, "Noto Sans", sans-serif' }}>
      <div className="layout-container flex h-full grow flex-col">
        <Header />
        <main className="px-4 sm:px-10 flex flex-1 justify-center py-8 sm:py-12">
          <div className="w-full max-w-md">

            <Card className="shadow-xl">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-bold text-slate-900 mb-2">
                  {isSignUp ? 'Join Stuff That Works' : 'Welcome Back'}
                </CardTitle>
                <p className="text-slate-600">
                  {isSignUp
                    ? 'Create an account to share your health journey and connect with others'
                    : 'Sign in to access your health community'
                  }
                </p>
              </CardHeader>
